...
shell.rm('-rf', path.join(outDir, 'assets'));
shell.rm('-rf', path.join(outDir, 'build'));
shell.rm('-rf', path.join(outDir, 'lib'));
shell.rm('-rf', path.join(outDir, 'icon.png'));
shell.rm('-rf', path.join(outDir, 'index.html'));
